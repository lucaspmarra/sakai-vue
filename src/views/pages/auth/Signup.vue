...
import AddressData from "./signup/AddressData.vue";
import ComplementData from "./signup/ComplementData.vue";
import PersonalData from "./signup/PersonalData.vue";
...
async function signUpNewUser() {
  const { data, error } = await supabase.auth.signUp({
    ...
    options: {
      emailRedirectTo: "http://localhost:5173/empty",
    },
  });
}
</script>
      ...
      >
        ...
        >
          ...
          <div>
            <Stepper value="1">
              <StepList>
                <Step value="1">{{ $t("signup.personal_data_step") }}</Step>
                <Step value="2">{{
                  $t("signup.complementary_data_step")
                }}</Step>
                <Step value="3">{{ $t("signup.address_data_step") }}</Step>
              </StepList>
              <StepPanels>
